                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4 text-center">
                                    <div class="flex items-center justify-center space-x-3">
                                        ...
                                        <form action="{{ route('admin.subjects.destroy', $subject->id) }}" method="POST" class="inline-block" onsubmit="return confirm('Peringatan: Menghapus mapel master akan menghapus seluruh data kelas dan materi yang terhubung dengannya! Lanjutkan?');">
                                            @csrf
                                            @method('DELETE')
