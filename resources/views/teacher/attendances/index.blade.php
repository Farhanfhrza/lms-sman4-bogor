<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto space-y-6" x-data="{ addMeetingModalOpen: false }">
        ...
        <div class="flex justify-between items-center mb-6">
            <button @click="addMeetingModalOpen = true" class="bg-[#1a6341] hover:bg-[#155034] text-white font-bold py-2.5 px-5 rounded-lg border-b-4 border-[#12422b] hover:border-[#0f3623] active:border-t-4 active:border-b-0 transition-all flex items-center shadow-sm">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path></svg>
                TAMBAH PERTEMUAN
            </button>
            <a href="{{ route('manage.courses.attendances.recap', $course) }}" class="bg-white border-2 border-[#1a6341] text-[#1a6341] hover:bg-green-50 font-bold py-2 px-5 rounded-lg flex items-center shadow-sm transition-colors">
