<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:flex-wrap gap-3 mb-6">
            ...
            <input type="text" placeholder="Search" class="w-full sm:w-auto border-gray-300 rounded-md shadow-sm focus:border-[#1a6341] focus:ring-[#1a6341] text-sm py-2 px-3 pl-8">
