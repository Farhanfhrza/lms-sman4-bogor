                        ...
                        @forelse($academicYears as $ay)
                            <tr class="hover:bg-gray-50 transition-colors {{ $ay->is_active ? 'bg-green-50/30' : '' }}">
                                ...
                                <td class="px-6 py-4 text-center">
                                    ...
                                    @else
                                        <form action="{{ route('admin.academic-years.activate', $ay) }}" method="POST" class="inline-block" onsubmit="return confirm('Mengaktifkan Tahun Ajaran ini akan me-nonaktifkan yang lain. Anda yakin?');">
                                            @csrf @method('PATCH')
                                            <button type="submit" class="text-gray-500 hover:text-[#1a6341] transition-colors border border-gray-300 hover:border-[#1a6341] px-3 py-1 rounded text-xs">
                                                Set Aktif
                                            </button>
                                        </form>
                                    @endif
                                ...
                                <td class="px-6 py-4 text-center">
                                    <div class="flex items-center justify-center space-x-3">
                                        ...
                                        <form action="{{ route('admin.academic-years.destroy', $ay) }}" method="POST" class="inline-block" onsubmit="return confirm('Yakin ingin menghapus Tahun Ajaran ini?');">
                                            @csrf @method('DELETE')
