            ...
            <div class="relative rounded-lg overflow-hidden mb-6 shadow-lg" style="height: 250px;">
                ...
                <div class="relative z-10 h-full flex flex-col justify-center px-8 md:px-12">
                    ...
                    <p class="text-xl text-green-100 font-medium">
                        {{ $classSubject->schoolClass->name ?? 'Kelas' }}
                    </p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="bg-white rounded-lg shadow-md p-6">
                        ...
                        @if($classSubject->sections && $classSubject->sections->count() > 0)
                    ...
                    @forelse($classSubject->sections ?? [] as $section)
                    ...
                    <div class="bg-white rounded-lg shadow-md p-6">
                        ...
                        <div class="flex items-center mb-4">
                            <div class="w-16 h-16 rounded-full overflow-hidden bg-gray-200 mr-4">
                                <img src="https://ui-avatars.com/api/?name={{ urlencode($classSubject->teacher->user->full_name ?? 'Teacher') }}&background=1a6341&color=fff&size=128" 
                                     alt="Teacher" 
                                     class="w-full h-full object-cover">
                            </div>
                            <div>
                                <p class="font-semibold text-gray-900">{{ $classSubject->teacher->user->full_name ?? 'Guru Pengajar' }}</p>
                                <p class="text-sm text-gray-500">{{ $classSubject->teacher->user->email ?? '' }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-lg shadow-md p-6">
                        ...
                        <div class="space-y-3">
                            <div>
                                ...
                                <p class="font-medium text-gray-900">{{ $classSubject->schoolClass->name ?? '-' }}</p>
                            </div>
                            <div>
                                <p class="text-sm text-gray-500">Tahun Ajaran</p>
                                <p class="font-medium text-gray-900">{{ $classSubject->academicYear->name ?? '-' }}</p>
                            </div>
                            <div>
                                <p class="text-sm text-gray-500">Total BAB</p>
                                <p class="font-medium text-gray-900">{{ $classSubject->sections->count() ?? 0 }} bab</p>
                            </div>
                        </div>
                    </div>
                </div>
