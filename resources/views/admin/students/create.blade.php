<x-app-layout>
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border-t-4 border-[#1a6341] relative">
        <div class="p-6 text-gray-900">
            ...
            <form method="POST" action="{{ route('admin.students.store') }}" class="max-w-2xl mx-auto space-y-5">
                @csrf
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-400 mt-1">Opsional. Jika kosong, akan otomatis di-generate dari NISN.</p>
                </div>
