                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4 text-center">
                                    <div class="flex items-center justify-center space-x-3">
                                        ...
                                        <button @click="$dispatch('open-confirm-modal-del-class-{{ $class->id }}')" class="text-red-500 hover:text-red-700 transition-colors" title="Hapus">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path></svg>
                                        </button>
                                        <x-confirm-delete-modal
                                            :id="'del-class-'.$class->id"
                                            title="Hapus Kelas?"
                                            :description="'Menghapus kelas &quot;'.$class->name.'&quot; akan berdampak pada seluruh siswa, jadwal, dan data sub-mapel yang terhubung.'"
                                            :confirmText="$class->name"
                                            :action="route('admin.classes.destroy', $class)"
                                            buttonLabel="Ya, Hapus Kelas"
                                        />
                                    </div>
                                </td>
                            </tr>
