<x-app-layout>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 md:p-8 mb-8">
        <div class="flex items-start gap-4">
            ...
            <div>
                <h3 class="text-xl font-bold text-[#1a6341] mb-3">{{ $assignment->title }}</h3>
    ...
    {{-- Rekap Jawaban Siswa --}}
    <div class="bg-white rounded-xl shadow-sm border border-gray-200" x-data="gradingTable()" x-cloak>

        {{-- Card Header --}}
        <div class="px-6 py-4 border-b border-gray-200">
            <h4 class="text-lg font-bold text-gray-800">Rekap Jawaban Siswa</h4>
        </div>
            ...
            <table class="w-full text-sm">
                <thead class="bg-gray-50 border-y border-gray-200">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-center font-semibold text-gray-600 uppercase tracking-wider text-xs w-20">Preview</th>
                    </tr>
                </thead>
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-4 py-3 text-center">
                                <span :class="{
                                          ...
                                          'text-gray-400 italic': row.nilaiColor === 'gray',
                                          'text-amber-600 italic': row.nilaiColor === 'yellow',
                            ...
                            {{-- PREVIEW --}}
                            <td class="px-4 py-3 text-center">
                                <template x-if="row.hasSubmission">
                                    <a :href="row.previewUrl"
